...
El elemento **ActualWork** representa la cantidad real de tiempo que se invierte en una tarea. 
...
El valor de texto para este elemento representa un número entero.
