...
|:-----|:-----|
|**ResponseClass** <br/> | Describe el estado de una respuesta de [la operación GetInboxRules](getinboxrules-operation.md) . <br/><br/>Los siguientes valores son válidos para este atributo: <br/> <br/>-Éxito  <br/>-Advertencia  <br/>-Error  <br/> |
...
|**Element**|**Descripción**|
|:-----|:-----|
|[MessageText](messagetext.md) <br/> |Proporciona la descripción de texto del estado de la respuesta.  <br/> |
...
|[OutlookRuleBlobExists](outlookruleblobexists.md) <br/> |Indica si existe un blob de regla de Microsoft Outlook en el buzón del usuario.  <br/> |
