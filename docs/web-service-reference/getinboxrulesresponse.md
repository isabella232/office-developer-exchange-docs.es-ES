...
|:-----|:-----|
|**ResponseClass** <br/> | Describe el estado de una respuesta de [operación de GetInboxRules](getinboxrules-operation.md) . <br/><br/>Los siguientes valores son válidos para este atributo: <br/> <br/>-Correcto  <br/>-ADVERTENCIA  <br/>-Error  <br/> |
...
|[OutlookRuleBlobExists](outlookruleblobexists.md) <br/> |Indica si existe un BLOB de reglas de Microsoft Outlook en el buzón de correo del usuario.  <br/> |
|[InboxRules](inboxrules.md) <br/> |Representa una matriz de las reglas en el buzón de correo del usuario.  <br/> |
