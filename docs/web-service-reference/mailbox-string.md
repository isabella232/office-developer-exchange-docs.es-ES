...
---
# <a name="mailbox-string"></a>Mailbox (cadena)

El elemento **Mailbox** contiene un identificador para un buzón. 
...
El valor de texto del elemento **Mailbox** es el identificador de un buzón. 
