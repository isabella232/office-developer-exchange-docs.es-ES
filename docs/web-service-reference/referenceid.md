...
El elemento **identificador** especifica el identificador de referencia para el buzón. 
...
El valor de texto del elemento **identificador** es el identificador de referencia de un buzón de correo. 
