...
El **elemento CreateFolderResponseMessage** contiene el estado y el resultado de una única [solicitud de operación CreateFolder.](createfolder-operation.md) 
...
|:-----|:-----|
|**ResponseClass** <br/> | Describe el estado de una respuesta de [operación CreateFolder.](createfolder-operation.md)<br/><br/>Los siguientes valores son válidos para este atributo:<br/><br/>- Éxito  <br/>- Advertencia  <br/>- Error  <br/> |
