...
description: El elemento MeetingMessage representa una reunión en el Exchange almacén.
ms.openlocfilehash: 2d4b74bf67613e37d8479d9ea7eb2ca4e9b161f8
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 09/24/2021
ms.locfileid: "59523968"
---
# <a name="meetingmessage"></a>MeetingMessage

El **elemento MeetingMessage** representa una reunión en el Exchange almacén. 
