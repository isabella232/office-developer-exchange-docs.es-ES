...
El elemento **DisplayNameLastFirstHeader** especifica el encabezado para el nombre para mostrar, apellido en primer lugar. 
...
El valor de texto del elemento **DisplayNameLastFirstHeader** es un valor de tipo string que especifica el nombre para mostrar, apellido en primer lugar. 
