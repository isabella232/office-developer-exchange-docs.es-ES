...
El elemento **ForwardAsAttachmentToRecipients** indica las direcciones de correo electrónico a la que los mensajes deben ser reenviado como datos adjuntos. 
