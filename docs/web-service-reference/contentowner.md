...
El elemento **ContentOwner** especifica el nombre del propietario del contenido. 
...
El valor de texto del elemento ContentOwner es una cadena que especifica la fecha de expiración del contenido.
