...
El elemento **ContactsFolderPermissionLevel** contiene los permisos para la carpeta Contactos predeterminada. Este elemento se introdujo en Microsoft Exchange Server 2007 Service Pack 1 (SP1). 
...
|:-----|:-----|
|None  <br/> |El usuario delegado no tiene ningún permiso de acceso a la carpeta Contactos.  <br/> |
|Reviewer  <br/> |El usuario delegado puede leer los elementos de la carpeta Contactos.  <br/> |
