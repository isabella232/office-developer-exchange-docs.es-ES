...
description: El elemento DisplayNameFirstLastHeader especifica el encabezado del nombre para mostrar, nombre primero.
ms.openlocfilehash: a40b8f80ff4000cd2eeb33db33d23f6640719773
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 09/24/2021
ms.locfileid: "59535529"
---
# <a name="displaynamefirstlastheader"></a>DisplayNameFirstLastHeader

El **elemento DisplayNameFirstLastHeader** especifica el encabezado del nombre para mostrar, nombre primero. 
