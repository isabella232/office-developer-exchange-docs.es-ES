...
El elemento **ReplyToAllItem** contiene una respuesta al remitente y a todos los destinatarios identificados de un elemento en el almacén de Exchange. 
...
El elemento [from](from.md) debe establecerse en la dirección de correo electrónico de la entidad de identidad si un elemento es una respuesta de un delegado. Si el delegado no establece la propiedad [from](from.md) , parecerá que el elemento se ha enviado directamente desde el buzón de correo del delegado. 
