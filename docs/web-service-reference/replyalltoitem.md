...
description: El elemento ReplyToAllItem contiene una respuesta al remitente y a todos los destinatarios identificados de un elemento en el Exchange almacén.
ms.openlocfilehash: 33dc348686e99e4f21b67b18780a6a6691a7d72a
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 09/24/2021
ms.locfileid: "59519019"
---
# <a name="replyalltoitem"></a>ReplyAllToItem

El **elemento ReplyToAllItem** contiene una respuesta al remitente y a todos los destinatarios identificados de un elemento del Exchange almacén. 
...
El [elemento From](from.md) debe establecerse en la dirección de correo electrónico de la entidad de seguridad si un elemento es una respuesta de un delegado. Si el delegado no establece la [propiedad From,](from.md) el elemento parecerá haber sido enviado directamente desde el buzón del delegado. 
