...
|**Element**|**Descripción**|
|:-----|:-----|
|[UpdateFolder](updatefolder.md) <br/> |Representa la operación que se utiliza para actualizar las propiedades de una carpeta.  <br/> La siguiente es la expresión de XPath para este elemento:  <br/>  `/UpdateFolder` <br/> |
