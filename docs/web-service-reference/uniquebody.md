...
El elemento **UniqueBody** representa un fragmento HTML o texto sin formato que representa el cuerpo único de esta conversación. 
...
|:-----|:-----|
|**BodyType** <br/> |Describe cómo se almacena el cuerpo del elemento en el elemento.  <br/> |
