...
El elemento **IsFromMe** indica si un usuario envió un elemento. 
...
Un valor de texto de **true** indica que un usuario envió el elemento. Un valor de **false** indica que el usuario no ha enviado el elemento. 
