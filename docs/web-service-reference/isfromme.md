...
El elemento **IsFromMe** indica si un usuario envía un elemento a él o a sí mismo. 
...
Un valor de texto de **true** indica que el elemento se envió a un usuario a él o a sí mismo. Un valor de **false** indica que el elemento no se ha enviado por el usuario a él o a sí mismo. 
