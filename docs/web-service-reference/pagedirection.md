...
El elemento **PageDirection** contiene la dirección para la paginación en el resultado de la búsqueda. El valor es anterior o siguiente. 
...
El valor de texto del elemento **PageDirection** es la dirección para la paginación de los resultados de búsqueda. 
