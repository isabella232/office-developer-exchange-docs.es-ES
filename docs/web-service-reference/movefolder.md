...
|**Element**|**Descripción**|
|:-----|:-----|
|[ToFolderId](tofolderid.md) <br/> |Representa la carpeta de destino para una carpeta que se ha movido.  <br/> |
|[FolderIds](folderids.md) <br/> |Contiene una matriz de las carpetas para mover a la carpeta identificada por el elemento [ToFolderId](tofolderid.md) .  <br/> |
