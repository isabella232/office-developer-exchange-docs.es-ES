...
El elemento **MailTipsAccessEnabled** representa la marca **MailTipsAccessEnabled()** . El elemento **MailTipsAccessEnabled** es sólo para uso interno. Este elemento no se usa en los clientes. 
