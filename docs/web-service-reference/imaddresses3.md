...
description: El elemento ImAddresses3 especifica una matriz de direcciones de mensaje instantáneo y los identificadores de sus atribuciones de origen para la persona asociada.
ms.openlocfilehash: 9a3106c0d3f51d090acaf0e23ffb817cb48fc8ef
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 09/24/2021
ms.locfileid: "59541157"
---
# <a name="imaddresses3"></a>ImAddresses3

El **elemento ImAddresses3** especifica una matriz de direcciones de mensaje instantáneo y los identificadores de sus atribuciones de origen para la persona asociada. 
