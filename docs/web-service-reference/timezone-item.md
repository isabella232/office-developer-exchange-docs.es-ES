...
---
# <a name="timezone-item"></a>TimeZone (elemento)

El elemento **TimeZone** proporciona una descripción de texto de una zona horaria. 
...
El valor de texto describe una zona horaria. Esta propiedad es de sólo lectura.
