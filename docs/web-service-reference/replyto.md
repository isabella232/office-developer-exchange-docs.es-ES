...
description: El elemento ReplyTo identifica una matriz de direcciones a las que se deben enviar las respuestas.
ms.openlocfilehash: 6121b545f252c4cc6668775e7219344309875027
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 09/24/2021
ms.locfileid: "59542823"
---
# <a name="replyto"></a>ReplyTo

El **elemento ReplyTo** identifica una matriz de direcciones a las que se deben enviar las respuestas. 
...
|:-----|:-----|
|[Buzón](mailbox.md) <br/> |Identifica un objeto de servicio de directorio de Active Directory habilitado para correo al que se envía una respuesta.  <br/> |
