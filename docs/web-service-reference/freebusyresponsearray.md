...
El elemento **FreeBusyResponseArray** contiene información sobre la disponibilidad de los usuarios solicitado y el estado de la respuesta. 
...
|**Element**|**Descripción**|
|:-----|:-----|
|[FreeBusyResponse](freebusyresponse.md) <br/> |Contiene la información de disponibilidad para un usuario de buzón único y el estado de la respuesta.  <br/> |
