...
El elemento **NewDisplayName** contiene el nombre para mostrar actualizado de un grupo de mensajería instantáneo. 
...
El valor de texto del elemento **NewDisplayName** es el nombre para mostrar actualizado de un grupo de mensajería instantáneo. 
