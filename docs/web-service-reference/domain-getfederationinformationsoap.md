...
El elemento de **dominio** identifica el dominio que tiene una confianza de federación. 
...
|**Element**|**Descripción**|
|:-----|:-----|
|[Solicitud (SOAP) (GetFederationInformation)](request-getfederationinformationsoap.md) <br/> |Representa una solicitud de [operación GetFederationInformation (SOAP)](getfederationinformation-operation-soap.md) .  <br/> |
