...
El elemento **PhoneticFirstName** contiene el nombre de un contacto, escrito fonéticamente. 
...
El valor de texto es una cadena que representa el nombre de un contacto, escrito fonéticamente.
