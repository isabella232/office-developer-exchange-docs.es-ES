...
El elemento **GetSharingMetadataResponse** define una respuesta a una solicitud de [operación GetSharingMetadata](getsharingmetadata-operation.md) . 
...
|[EncryptedSharedFolderDataCollection](encryptedsharedfolderdatacollection.md) <br/> |Contiene una colección de estructuras de datos que un cliente puede usar para autorizar el uso compartido de su calendario o póngase en contacto con datos con otros clientes.  <br/> |
|[InvalidRecipients](invalidrecipients.md) <br/> |Representa a los destinatarios de la solicitud de compartir carpetas que no son válidos.  <br/> |
