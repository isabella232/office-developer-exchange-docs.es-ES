...
El elemento **IconIndex** identifica el índice de icono para un elemento o conversación. 
...
En la siguiente tabla contiene los posibles valores de texto para el elemento **IconIndex** . 
...
|SmsSubmitted  <br/> |Especifica el correo de icono enviado para el enrutamiento de servicio de mensajes cortos (SMS).  <br/> |
