...
description: El elemento TentativelyAcceptItem representa una respuesta provisional a una solicitud de reunión.
ms.openlocfilehash: 5469f947497506a5630653c76e8d03ec5fd689ff
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 09/24/2021
ms.locfileid: "59515225"
---
# <a name="tentativelyacceptitem"></a>TentativelyAcceptItem

El **elemento TentativelyAcceptItem** representa una respuesta provisional a una solicitud de reunión. 
...
|[ProposedStart](proposedstart.md) <br/> |Especifica la hora de inicio propuesta de la solicitud de reunión.  <br/> |
|[ProposedEnd](proposedend.md) <br/> |Especifica la hora de finalización propuesta de la solicitud de reunión.  <br/> |
