...
El elemento **MailBoxMoveEnabled** representa la marca **MailboxMoveEnabled()** . El elemento **MailBoxMoveEnabled** es sólo para uso interno. Este elemento no se usa en los clientes. 
