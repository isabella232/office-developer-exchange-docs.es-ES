...
---
# <a name="userid-string"></a>UserId (cadena)

El elemento **userid** especifica el identificador de usuario de un usuario de correo electrónico. 
...
El valor de texto del elemento **userid** es un identificador de un usuario de correo electrónico. 
