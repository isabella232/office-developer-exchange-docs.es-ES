...
El elemento **ReceivedTime** especifica la hora en que se recibió un elemento. 
...
El valor de texto del elemento **ReceivedTime** es la fecha y la hora en que se recibió un elemento. 
