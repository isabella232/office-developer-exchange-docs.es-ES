...
El elemento **GetAttachmentResponseMessage** contiene el estado y el resultado de una única solicitud de [operación GetAttachment](getattachment-operation.md) . 
...
|:-----|:-----|
|**ResponseClass** <br/> | Describe el estado de una respuesta de la [operación GetAttachment](getattachment-operation.md) .<br/><br/> Los siguientes valores son válidos para este atributo: <br/> <br/>-Correcto  <br/>-ADVERTENCIA  <br/>-Error  <br/> |
...
|[Datos adjuntos](attachments-ex15websvcsotherref.md) <br/> |Contiene los elementos o archivos que se ttached a un elemento en el almacén de Exchange.  <br/> |
