...
El elemento **ContactString** especifica el nombre para mostrar de un contacto. 
...
El valor de texto del elemento **ContactString** es el valor de tipo string que especifica el nombre para mostrar. 
