...
---
# <a name="pagers"></a>Localizadores

El elemento **localizadores** especifica una matriz de números de teléfono del buscapersonas y los identificadores de sus atribuciones de origen para el rol asociado. 
