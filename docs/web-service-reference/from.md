...
El elemento **de** representa la dirección desde la que se envió el mensaje. 
...
Este elemento se utiliza para mensajes de correo electrónico "enviar en nombre de".
