...
El elemento **SubscribeResponseMessage** contiene el estado y el resultado de una única solicitud [Subscribe operación](subscribe-operation.md) . 
...
|:-----|:-----|
|**ResponseClass** <br/> | Describe el estado de una respuesta de [la operación Suscribir](subscribe-operation.md) . <br/><br/>Los siguientes valores son válidos para este atributo:  <br/><br/>-Éxito  <br/>-Advertencia  <br/>-Error  <br/> |
...
|[Marca de agua](watermark.md) <br/> |Representa un marcador de evento en la cola de eventos de buzón de correo.  <br/> |
