...
El elemento **MarkImportance** especifica la importancia que se mostrará en los mensajes. 
...
El valor de texto para este elemento está restringido a uno de los siguientes valores de cadena:
