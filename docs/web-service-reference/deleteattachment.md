...
El elemento **DeleteAttachment** es el elemento raíz en una solicitud para eliminar un archivo adjunto desde el almacén de Exchange. 
...
|**Element**|**Descripción**|
|:-----|:-----|
|[AttachmentIds](attachmentids.md) <br/> |Contiene una matriz de identificadores de los datos adjuntos que se usan para eliminar los datos adjuntos.  <br/> |
