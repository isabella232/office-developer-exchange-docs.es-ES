...
---
# <a name="profession"></a>Profesión

El elemento **profesional** representa los profesionales de un contacto. 
...
Se requiere un valor de texto que representa un profesional.
