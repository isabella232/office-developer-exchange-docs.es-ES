...
Obtenga información acerca de la operación de EWS **FindPeople** . 
  
La operación **FindPeople** devuelve todos los objetos de rol desde una carpeta de contactos especificada o recupera los contactos que coinciden con una cadena de consulta especificada. 
  
Esta operación se introdujo en Exchange Server 2013.
  
## <a name="using-the-findpeople-operation"></a>Mediante la operación FindPeople

La operación **FindPeople** devuelve información de contacto agregada. 
  
La operación de **FindPeople** se basa en la funcionalidad existente de los tipos complejos de [restricción](restriction.md) y [BaseShape](baseshape.md) mediante la adición de una restricción de agregación y la capacidad para devolver propiedades adicionales. Mediante el uso de una restricción, un cliente puede especificar filtros como "solo devuelven resultados que tienen una dirección de mensajería instantánea". El comportamiento de búsqueda predeterminado dirige a buzón personal del usuario especificado y la lista global de direcciones (GAL). Al buscar en la lista global de direcciones como la carpeta de búsqueda principal, debe especificar una cadena de consulta en lugar de una restricción, debido a que esta operación no se admite para la exploración de la lista global de direcciones. 
  
### <a name="findpeople-operation-soap-headers"></a>Encabezados SOAP de operación de FindPeople

La operación de **FindPeople** puede utilizar los encabezados SOAP que se enumeran en la siguiente tabla. 
...
## <a name="findpeople-operation-request-example"></a>Ejemplo de solicitud de operación de FindPeople

El siguiente ejemplo de una solicitud de operación **FindPeople** muestra cómo devolver los primeros 100 contactos desde la carpeta Contactos. 
...
El siguiente ejemplo de una solicitud de operación **FindPeople** muestra cómo devolver los primeros 100 contactos desde la lista global de direcciones mediante el uso de una cadena de consulta. Configuración de la **DistinguishedFolderId** al "directorio" buscará en la lista global de direcciones como el origen principal de roles. 
...
## <a name="successful-findpeople-operation-response"></a>Respuesta es correcta de operación FindPeople
...
## <a name="findpeople-operation-error-response"></a>Respuesta de error de la operación de FindPeople
