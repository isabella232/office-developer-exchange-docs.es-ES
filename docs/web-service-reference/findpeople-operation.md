...
- [<span data-ttu-id="033f2-158">RoutingType (EmailAddressType)</span><span class="sxs-lookup"><span data-stu-id="033f2-158">RoutingType (EmailAddressType)</span></span>](routingtype-emailaddresstype.md)
