...
description: El elemento FileAsIds especifica una matriz de elementos StringAttributedValue y los identificadores de sus atribuciones de origen para la persona asociada.
ms.openlocfilehash: c73890edd19f9b00511ed2d10b21e3b10516d87f
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 09/24/2021
ms.locfileid: "59546521"
---
# <a name="fileasids"></a>FileAsIds

El **elemento FileAsIds** especifica una matriz de **elementos StringAttributedValue** y los identificadores de sus atribuciones de origen para la persona asociada. 
