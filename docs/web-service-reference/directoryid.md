...
El elemento **DirectoryId** contiene el identificador de directorio de un contacto. 
...
El valor de texto es una cadena que representa el identificador de directorio del contacto.
