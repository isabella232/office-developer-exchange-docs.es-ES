...
El elemento **TargetSharingEpr** representa la propiedad **TargetSharingEpr** . El elemento **TargetSharingEpr** es sólo para uso interno. Este elemento no se usa en los clientes. 
