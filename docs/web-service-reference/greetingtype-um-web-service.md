...
El elemento **GreetingType** define el tipo de saludo para usar en una solicitud de [operación PlayOnPhoneGreeting (servicio web de mensajería unificada)](playonphonegreeting-operation-um-web-service.md) . 
...
|**Element**|**Descripción**|
|:-----|:-----|
|[PlayOnPhoneGreeting (servicio web de mensajería unificada)](playonphonegreeting-um-web-service.md) <br/> |Define una solicitud para reproducir un mensajería unificada en un teléfono de saludo.  <br/> |
