...
description: El elemento MessageCount contiene el número total de elementos de conversación de la carpeta actual.
ms.openlocfilehash: ef02d4e03136a4dead0be7e1d0fe95ff32a21e4b
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 09/24/2021
ms.locfileid: "59523961"
---
# <a name="messagecount"></a>MessageCount

El **elemento MessageCount** contiene el número total de elementos de conversación de la carpeta actual. 
...
El valor de texto del **elemento MessageCount** es el número total de elementos de conversación de una carpeta. 
