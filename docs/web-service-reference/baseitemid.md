...
El elemento **BaseItemId** representa la clase base para los identificadores que representan elementos de un buzón de correo. Esto es una clase abstracta y, por tanto, no se producirá en un documento de instancia. 
...
Este elemento es un tipo base abstracto para los identificadores de elemento. Este elemento no se usa en las llamadas de servicio Web.
