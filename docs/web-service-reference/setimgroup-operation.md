...
Buscar información sobre la operación de EWS de **SetImGroup** . 
...
La operación **SetImGroup** sólo toma un único argumento nombre para mostrar. 
  
### <a name="setimgroup-operation-soap-headers"></a>Encabezados SOAP de operación SetImGroup
...
El siguiente ejemplo de una solicitud de operación de **SetImGroup** muestra cómo cambiar el nombre para mostrar de un grupo de mensajería instantánea a "MyNewGroupName". 
  
> [!NOTE]
> El identificador del almacén de Exchange se ha abreviado para preservar la legibilidad. 
...
## <a name="successful-setimgroup-operation-response"></a>Respuesta de operación SetImGroup correcta

En el ejemplo siguiente se muestra una respuesta correcta a una solicitud de operación de **SetImGroup** . 
...
## <a name="setimgroup-operation-error-response"></a>Respuesta de error de operación de SetImGroup

En el ejemplo siguiente se muestra una respuesta de error a una solicitud de operación **SetImGroup** . Se produce la siguiente respuesta de error cuando se realiza un intento de cambiar el nombre para mostrar del grupo al nombre para mostrar del grupo existente. 
