...
El elemento **ReminderIsSet** indica si se ha establecido un aviso para un elemento en el almacén de Exchange. 
...
Un valor de texto de **true** indica que se ha establecido un aviso. 
