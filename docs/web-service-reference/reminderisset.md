...
description: El elemento ReminderIsSet indica si se ha establecido un aviso para un elemento en el Exchange almacén.
ms.openlocfilehash: 2faa32b9b58789ecefd3b0c412d764765d5afada
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 09/24/2021
ms.locfileid: "59513426"
---
# <a name="reminderisset"></a>ReminderIsSet

El **elemento ReminderIsSet** indica si se ha establecido un aviso para un elemento en el Exchange almacén. 
