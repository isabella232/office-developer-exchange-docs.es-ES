...
---
# <a name="size-long"></a>Tamaño (largo)

El elemento **size** especifica el tamaño total de uno o más elementos de buzón de correo. 
...
El valor de texto del elemento **size** es el tamaño total de uno o más elementos del buzón de correo. 
