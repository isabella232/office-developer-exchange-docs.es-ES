...
El elemento **IsVoicemail** indica si los mensajes entrantes deben ser los mensajes de correo de voz en orden para la condición o la excepción que se debe aplicar. 
...
Un valor de texto de **true** indica que el mensaje debe ser un mensaje de correo de voz en orden para la condición o la excepción que se debe aplicar. Un valor de **false** indica que el mensaje no debe ser un mensaje de correo de voz en orden para la condición o la excepción que se debe aplicar. 
