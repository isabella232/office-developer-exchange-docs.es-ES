...
El elemento **BeginTime** especifica el principio de un período de tiempo para consultar avisos. 
...
El valor de texto del elemento **BeginTime** es que la hora de comienzo del elemento el aviso es para. 
