...
El elemento **InReplyTo** representa el identificador del elemento al que este elemento es una respuesta. 
...
El valor de texto representa una cadena que identifica un elemento.
