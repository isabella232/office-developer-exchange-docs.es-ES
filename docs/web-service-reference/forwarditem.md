...
El elemento **ForwardItem** contiene un elemento de almacén de Exchange para reenviar a los destinatarios. 
...
El elemento [from](from.md) debe establecerse en la dirección de correo electrónico del objeto principal si un delegado reenvía un elemento. Si el delegado no establece la propiedad [from](from.md) , parecerá que el elemento se ha enviado directamente desde el buzón de correo del delegado. 
