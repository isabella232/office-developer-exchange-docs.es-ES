...
|:-----|:-----|
|**ResponseClass** <br/> | Describe el estado de una respuesta de [la operación CopyFolder](copyfolder-operation.md) .<br/><br/>Los siguientes valores son válidos para este atributo:<br/><br/>-Éxito  <br/>-Advertencia  <br/>-Error  <br/> |
...
|[Carpetas](folders-ex15websvcsotherref.md) <br/> |Contiene una matriz de carpetas copiadas.  <br/> |
