...
El elemento **FormattedAddress** especifica el valor de la presentación con formato de la dirección postal asociado. 
...
|**Element**|**Descripción**|
|:-----|:-----|
|[Valor (PersonaPostalAddressType)](value-personapostaladdresstype.md) <br/> |Especifica información asociada con una dirección postal.  <br/> |
...
El valor de texto del elemento **FormattedAddress** es un valor de tipo string que especifica la dirección con formato. 
