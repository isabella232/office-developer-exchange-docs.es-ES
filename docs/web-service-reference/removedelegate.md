...
|[UserIds](userids.md) <br/> |Contiene una matriz de usuarios delegados para quitar del buzón de una entidad de la identidad. Este elemento se introdujo en Exchange 2007 SP1.  <br/> |
