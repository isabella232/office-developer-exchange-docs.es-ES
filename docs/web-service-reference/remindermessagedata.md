...
description: El elemento ReminderMessageData especifica los datos de un mensaje de aviso.
ms.openlocfilehash: d916e1526f11795efa54cdf186d606bc293656e0
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 09/24/2021
ms.locfileid: "59512453"
---
# <a name="remindermessagedata"></a>ReminderMessageData

El **elemento ReminderMessageData** especifica los datos de un mensaje de aviso. 
