...
El elemento **PageItemCount** especifica el número de páginas devueltas en una paginación de resultados de búsqueda. 
...
El valor de texto del elemento **PageItemCount** es el número de páginas devueltas en una paginación de resultados de búsqueda. 
