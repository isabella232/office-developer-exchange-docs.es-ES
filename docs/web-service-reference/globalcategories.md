...
El elemento **GlobalCategories** contiene la lista de categorías para todos los elementos de la conversación en un buzón de correo. 
...
|**Element**|**Descripción**|
|:-----|:-----|
|[String](string.md) <br/> |Contiene una única categoría.  <br/> |
