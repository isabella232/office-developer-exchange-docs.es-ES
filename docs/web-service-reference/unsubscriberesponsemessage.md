...
description: El elemento UnsubscribeResponseMessage contiene el estado y el resultado de una única solicitud de operación Unsubscribe.
...
El **elemento UnsubscribeResponseMessage** contiene el estado y el resultado de una única solicitud [de operación Unsubscribe.](unsubscribe-operation.md) 
...
|:-----|:-----|
|**ResponseClass** <br/> | Describe el estado de una respuesta de [operación Cancelar](unsubscribe-operation.md) suscripción. <br/><br/>Los siguientes valores son válidos para este atributo: <br/> <br/>- Éxito  <br/>- Advertencia  <br/>- Error  <br/> |
