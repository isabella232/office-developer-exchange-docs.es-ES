...
description: El elemento DisconnectPhoneCallResponse contiene el estado y el resultado de una única solicitud DisconnectPhoneCall.
ms.openlocfilehash: a8a5c7e238baeee79542cad41af184632b66d4e2
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 09/24/2021
ms.locfileid: "59535567"
---
# <a name="disconnectphonecallresponse"></a>DisconnectPhoneCallResponse

El **elemento DisconnectPhoneCallResponse** contiene el estado y el resultado de una única **solicitud DisconnectPhoneCall.** 
