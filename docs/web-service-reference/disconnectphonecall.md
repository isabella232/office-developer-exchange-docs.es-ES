...
El elemento **DisconnectPhoneCall** representa una solicitud para desconectar la llamada. 
...
|**Element**|**Descripción**|
|:-----|:-----|
|[PhoneCallId](phonecallid.md) <br/> |Especifica el identificador de la llamada a desconectar. Se requiere este elemento.  <br/> |
