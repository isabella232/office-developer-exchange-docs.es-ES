...
Elemento **DisplayName** representa un nombre para mostrar. 
...
El valor de texto del elemento **DisplayName** es el nombre para mostrar de una opción de configuración. 
