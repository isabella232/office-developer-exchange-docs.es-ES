...
El elemento **LocationUrl** representa la dirección URL de un documento de ubicación de uso compartido. 
...
El valor de texto del elemento **LocationUrl** es la dirección URL de un documento de ubicación de uso compartido. 
