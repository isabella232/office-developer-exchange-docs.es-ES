...
El elemento **PictureData** contiene la secuencia de datos de imagen. 
...
El valor de texto del elemento **PictureData** es la secuencia con codificación base64 de los datos de imagen. 
