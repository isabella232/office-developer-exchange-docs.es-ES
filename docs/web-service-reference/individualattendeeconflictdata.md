...
El elemento **IndividualAttendeeConflictData** contiene un usuario o estado de disponibilidad del contacto para una ventana de tiempo que se produce al mismo tiempo, como el tiempo de la reunión sugerida identificados en el elemento de [Sugerencia](suggestion.md) . 
