...
El elemento **LargeAudienceThreshold** representa el umbral de gran audiencia para un cliente. 
...
El valor de texto es un entero que representa el umbral de audiencia que indica que el mensaje va a más de una persona.
