...
El elemento **LargeAudienceThreshold** representa el umbral de audiencia grande para un cliente. 
...
El valor de texto es un entero que representa el umbral de audiencia que indica que el mensaje se va a más de una persona.
