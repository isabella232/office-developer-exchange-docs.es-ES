...
description: El elemento Message representa un mensaje Exchange de correo electrónico de Microsoft.
...
El **elemento Message** representa un mensaje Exchange de correo electrónico de Microsoft. 
...
|[BccRecipients](bccrecipients.md) <br/> |Representa una colección de destinatarios para recibir una copia de carbón ciego (CCO) de un mensaje de correo electrónico.  <br/> |
...
|[ReceivedBy](receivedby.md) <br/> |Identifica al delegado en un escenario de acceso delegado.  <br/> |
|[ReceivedRepresenting](receivedrepresenting.md) <br/> |Identifica la entidad de seguridad en un escenario de acceso delegado.  <br/> |
...
Las **operaciones de** disponibilidad usan otro elemento [Message, Message (Availability)](message-availability.md) para devolver mensajes OOF. 
  
[Los](message-ex15websvcsotherref.md) elementos message representan mensajes de correo electrónico y todos los demás elementos que no están fuertemente especificados por el esquema Exchange Web Services (EWS). Elementos como IPM. El uso compartido y IPM.InfoPath se devuelven como **elementos Message.** Exchange 2010 no devuelve el **elemento Item** base en las respuestas. 
