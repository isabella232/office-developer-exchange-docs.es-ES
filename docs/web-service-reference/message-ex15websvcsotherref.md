...
El elemento de **mensaje** representa un mensaje de correo electrónico de Microsoft Exchange. 
...
|[ReminderMessageData](remindermessagedata.md) <br/> |Contiene los datos para un mensaje de aviso.  <br/> |
...
Elementos del [mensaje](message-ex15websvcsotherref.md) representan los mensajes de correo electrónico y todos los otros elementos que no están fuertemente tipados por el esquema de Exchange Web Services (EWS). Elementos como IPM. Uso compartido y IPM.InfoPath se devuelven como elementos del **mensaje** . Exchange 2010 no devuelve **el elemento de base** de las respuestas. 
