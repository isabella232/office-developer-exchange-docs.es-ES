...
El elemento **Message** representa un mensaje de correo electrónico de Microsoft Exchange. 
...
|[BccRecipients](bccrecipients.md) <br/> |Representa una colección de destinatarios para recibir una copia oculta (CCO) de un mensaje de correo electrónico.  <br/> |
...
|[ReceivedBy](receivedby.md) <br/> |Identifica el delegado en un escenario de acceso delegado.  <br/> |
|[ReceivedRepresenting](receivedrepresenting.md) <br/> |Identifica la entidad de identidad en un escenario de acceso delegado.  <br/> |
...
|[ReminderMessageData](remindermessagedata.md) <br/> |Contiene los datos de un mensaje de aviso.  <br/> |
...
Las operaciones de disponibilidad usan otro elemento de **mensaje** , [Message (disponibilidad)](message-availability.md) para devolver mensajes OOF. 
  
Los elementos de [mensaje](message-ex15websvcsotherref.md) representan mensajes de correo electrónico y todos los demás elementos que no son fuertemente tipados por el esquema de servicios web Exchange (EWS). Elementos como IPM. Uso compartido e IPM. InfoPath se devuelven como elementos del **mensaje** . Exchange 2010 no devuelve el elemento de **elemento** base en las respuestas. 
