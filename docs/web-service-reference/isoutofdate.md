...
El elemento **IsOutOfDate** indica si un mensaje de la reunión, solicitud, respuesta o cancelación no está actualizada. 
...
Un valor de texto de **true** indica que el elemento de reunión está obsoleto. 
