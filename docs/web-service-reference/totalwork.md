...
El elemento **TotalWork** contiene una descripción de la cantidad de trabajo está asociado a una tarea. 
...
El valor de texto corresponde a un número entero que representa la cantidad total de trabajo que está asociado a una tarea.
