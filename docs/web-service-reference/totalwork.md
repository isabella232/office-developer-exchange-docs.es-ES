...
El elemento de trabajo **total** contiene una descripción de la cantidad de trabajo asociado a una tarea. 
...
El valor de texto corresponde a un entero que representa la cantidad total de trabajo asociado a una tarea.
