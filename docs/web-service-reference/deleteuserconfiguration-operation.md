...
## <a name="deleteuserconfiguration-request-example"></a>Ejemplo de solicitud de DeleteUserConfiguration

### <a name="description"></a>Descripción

El siguiente ejemplo de una solicitud de **DeleteUserConfiguration** muestra cómo formar una solicitud para eliminar un objeto de configuración de usuario en la carpeta Borradores. 
...
En el ejemplo siguiente se muestra una respuesta correcta a la solicitud de **DeleteUserConfiguration** . 
