...
El elemento **FreeBusyChangedEvent** representa un evento en el que ha cambiado la hora de disponibilidad de un elemento. 
...
|[Marca](timestamp.md) <br/> |Representa la marca de hora de un evento de buzón de elemento de disponibilidad.  <br/> |
