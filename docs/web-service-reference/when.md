...
---
# <a name="when"></a>Cuando se ejecuta

El elemento **cuando** proporciona información acerca de cuándo se produce un elemento de reunión o un calendario. 
...
El valor de texto es una cadena que describe cuando se produce un elemento de calendario.
