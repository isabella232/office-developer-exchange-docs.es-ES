...
El elemento **IsDraft** indica si todavía no se ha enviado un elemento. 
...
Se requiere un valor de texto que representa un valor booleano. Un valor de **true** indica que todavía no se ha enviado un mensaje. Un valor de **false** indica que se ha enviado un mensaje. 
