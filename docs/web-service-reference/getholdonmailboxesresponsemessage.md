...
El elemento **GetHoldOnMailboxesResponseMessage** especifica el mensaje de respuesta de una solicitud de **GetHoldOnMailboxes** . 
...
|**Element**|**Descripción**|
|:-----|:-----|
|[MailboxHoldResult](mailboxholdresult.md) <br/> |Contiene el resultado de la solicitud de **GetHoldOnMailboxes** .  <br/> |
