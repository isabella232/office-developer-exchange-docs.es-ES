...
El elemento **UpdateInboxRulesResponse** define una respuesta a una solicitud de UpdateInboxRules. 
...
|:-----|:-----|
|**ResponseClass** <br/> | Describe el estado de una respuesta de la [operación de cancelación de suscripción](unsubscribe-operation.md) .<br/><br/> Los siguientes valores son válidos para este atributo:  <br/><br/>-Éxito  <br/>-Advertencia  <br/>-Error  <br/> |
