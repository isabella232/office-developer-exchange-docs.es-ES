...
ms.locfileid: "59523624"
---
# <a name="reminderdueby"></a>ReminderDueBy

El **elemento ReminderDueBy** representa la fecha y hora en que se produce el evento. El elemento [ReminderMinutesBeforeStart](reminderminutesbeforestart.md) lo usa para determinar cuándo se muestra el aviso. 
...
El valor de texto representa la fecha y hora en que vence un aviso.
