...
El elemento **RefreshSharingFolder** define una solicitud para actualizar la carpeta local especificada. Es el elemento base para la [operación RefreshSharingFolder](refreshsharingfolder-operation.md).
