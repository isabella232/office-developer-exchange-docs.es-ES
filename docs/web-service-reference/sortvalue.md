...
El elemento **SortValue** especifica un valor que se usa para la ordenación. 
...
El valor de texto del elemento [SortValue](sortvalue.md) es el campo que se usa para ordenar el conjunto de resultados. 
