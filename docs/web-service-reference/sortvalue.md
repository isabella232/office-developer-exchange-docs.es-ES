...
El elemento **SortValue** especifica un valor que se utiliza para la ordenación. 
...
El valor de texto del elemento [SortValue](sortvalue.md) es el campo que se utiliza para ordenar el conjunto de resultados. 
