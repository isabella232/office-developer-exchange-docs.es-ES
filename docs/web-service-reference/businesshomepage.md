...
El elemento **BusinessHomePage** representa la Página principal (dirección web) del contacto. 
...
El valor de texto representa un identificador uniforme de recursos (URI) para la Página principal.
