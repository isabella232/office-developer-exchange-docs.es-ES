...
El elemento **BusinessHomePage** representa la página principal (dirección Web) para el contacto. 
...
El valor de texto representa un identificador uniforme de recursos (URI) de la página principal.
