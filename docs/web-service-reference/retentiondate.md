...
El elemento **RetentionDate** especifica la última fecha en que se debe conservar un elemento. 
...
El valor de texto del elemento **RetentionDate** representa la fecha cuando ya no se debe conservar un elemento. 
