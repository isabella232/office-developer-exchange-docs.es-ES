...
El elemento **MeetingCancellation** representa una cancelación de reunión en el almacén de Exchange. 
...
|[ReminderMinutesBeforeStart](reminderminutesbeforestart.md) <br/> |Representa el número de minutos antes de un evento que se muestra un aviso.  <br/> |
