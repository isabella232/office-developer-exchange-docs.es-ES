...
La operación **GetRoomLists** Obtiene las listas de las salas disponibles dentro de la organización de Exchange. 
  
## <a name="soap-headers"></a>Encabezados SOAP

La operación de **GetRoomLists** puede utilizar los encabezados SOAP que se enumeran y describen en la tabla siguiente. 
...
## <a name="getroomlists-request-example"></a>Ejemplo de solicitud de GetRoomLists

### <a name="description"></a>Descripción

El siguiente es un ejemplo de una solicitud de **GetRoomLists** que devuelve las listas de las salas que están disponibles en el servidor. 
...
## <a name="successful-getroomlists-response-example"></a>Ejemplo de respuesta correcta de GetRoomLists

### <a name="description"></a>Descripción

El siguiente es un ejemplo de una respuesta a una solicitud de **GetRoomLists** . Esta respuesta muestra una lista de salas en el servidor. 
...
### <a name="successful-getroomlists-response-elements"></a>Elementos de respuesta correctos de GetRoomLists
...
### <a name="getroomlists-error-response-example"></a>Ejemplo de respuesta de GetRoomLists Error

#### <a name="description"></a>Descripción

En el ejemplo siguiente se muestra la respuesta a un intento para obtener listas de las salas de un servidor que no tiene las listas de las salas definidas.
...
#### <a name="getroomlists-error-response-elements"></a>Elementos de respuesta de GetRoomLists Error
