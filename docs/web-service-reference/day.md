...
ms.locfileid: "59524388"
---
# <a name="day"></a>Day

El **elemento Day** representa el día del mes en el que se produce la transición de zona horaria. 
...
El valor de texto del **elemento Day** es un entero que representa el día del mes en el que se produce la transición de zona horaria. 
