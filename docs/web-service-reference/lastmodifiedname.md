...
El elemento **LastModifiedName** contiene el nombre para mostrar del último usuario para modificar un elemento. Este elemento es de sólo lectura. Este elemento se introdujo en Microsoft Exchange Server 2007 Service Pack 1 (SP1). 
...
El valor de texto es un valor de tipo string que representa el nombre para mostrar del último usuario para modificar el elemento.
