...
description: El elemento LastModifiedName contiene el nombre para mostrar del último usuario que modifica un elemento. Este elemento es de solo lectura. Este elemento se introdujo en Microsoft Exchange Server 2007 Service Pack 1 (SP1).
...
El **elemento LastModifiedName** contiene el nombre para mostrar del último usuario que modifica un elemento. Este elemento es de solo lectura. Este elemento se introdujo en Microsoft Exchange Server 2007 Service Pack 1 (SP1). 
...
|[PostItem](postitem.md) <br/> |Representa un elemento de publicación en el Exchange almacén. Este elemento se introdujo en Exchange 2007 SP1.  <br/> |
   
## <a name="text-value"></a>Valor de texto

El valor de texto es un valor de cadena que representa el nombre para mostrar del último usuario que modifica el elemento.
