...
---
# <a name="value-message-tracking"></a>Valor (el seguimiento de mensajes)

El elemento de **valor** representa el valor de la propiedad para un informe de seguimiento de mensajes. 
...
Este elemento puede aparecer como máximo una vez en el elemento [TrackingPropertyType](trackingpropertytype.md) . 
