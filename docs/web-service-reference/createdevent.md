...
description: El elemento CreatedEvent representa un evento en el que se crea un elemento o carpeta.
ms.openlocfilehash: ab93117274b5084d691556a978d6420b9c7f70c3
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 09/24/2021
ms.locfileid: "59510354"
---
# <a name="createdevent"></a>CreatedEvent

El **elemento CreatedEvent** representa un evento en el que se crea un elemento o carpeta. 
...
|[TimeStamp](timestamp.md) <br/> |Representa la marca de tiempo de un evento de buzón de carpeta o elemento creado.  <br/> |
...
|[ParentFolderId](parentfolderid.md) <br/> |Representa el identificador de la carpeta principal del elemento o carpeta creado.  <br/> |
