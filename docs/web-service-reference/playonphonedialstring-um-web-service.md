...
El elemento **PlayOnPhoneDialString** contiene un valor para la cadena de marcado de forma predeterminada en una solicitud de [operación GetUMProperties (servicio web de mensajería unificada)](getumproperties-operation-um-web-service.md) . 
