...
description: El elemento GivenNames especifica una matriz de valores de nombre determinados y los identificadores de sus atribuciones de origen para la persona asociada.
ms.openlocfilehash: 7da46685ec9ec44a81e0aca813969bd00cb858df
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 09/24/2021
ms.locfileid: "59539988"
---
# <a name="givennames"></a>GivenNames

El **elemento GivenNames** especifica una matriz de valores de nombre determinados y los identificadores de sus atribuciones de origen para la persona asociada. 
