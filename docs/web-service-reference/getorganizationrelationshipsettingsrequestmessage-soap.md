...
El elemento **GetOrganizationRelationshipSettingRequestMessage** representa una solicitud de operación de la [operación de GetOrganizationRelationshipSettings (SOAP)](getorganizationrelationshipsettings-operation-soap.md) . El elemento **GetOrganizationRelationshipSettingRequestMessage** es sólo para uso interno. Este elemento no se usa en los clientes. 
...
|**Element**|**Descripción**|
|:-----|:-----|
|[Solicitud (SOAP) (GetOrganizationRelationship)](request-getorganizationrelationshipsoap.md) <br/> |Representa una solicitud de [GetOrganizationRelationshipSettingsRequest (SOAP)](getorganizationrelationshipsettingsrequest-soap.md) .  <br/> |
