...
---
# <a name="titles"></a>Tratamiento

El elemento **titles** especifica una matriz de puestos de trabajo y los identificadores de sus atribuciones de origen para el rol asociado. 
