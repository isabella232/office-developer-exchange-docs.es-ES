...
---
# <a name="getumproperties-um-web-service"></a>GetUMProperties (servicio Web de mensajería unificada)

El elemento **GetUMProperties** define una solicitud de [operación GetUMProperties (servicio Web de mensajería unificada)](getumproperties-operation-um-web-service.md) . 
