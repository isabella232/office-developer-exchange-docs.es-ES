...
El elemento **RetentionPolicyTagId** especifica el identificador de la etiqueta de directiva de retención. 
...
El valor de texto del elemento **RetentionPolicyTagId** es el identificador de la etiqueta de directiva que se aplica a los elementos de una conversación. 
