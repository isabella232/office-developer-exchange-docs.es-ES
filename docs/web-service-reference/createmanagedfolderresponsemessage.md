...
|:-----|:-----|
|**ResponseClass** <br/> | Describe el estado de una respuesta de [operación CreateManagedFolder.](createmanagedfolder-operation.md)<br/><br/>Los siguientes valores son válidos para este atributo:<br/><br/>- Éxito  <br/>- Advertencia  <br/>- Error  <br/> |
...
|[Folders](folders-ex15websvcsotherref.md) <br/> |Contiene una matriz de carpetas administradas creadas.  <br/> |
