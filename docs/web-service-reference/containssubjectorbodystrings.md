...
|:-----|:-----|
|[String](string.md) <br/> |Representa una cadena que debe aparecer en el cuerpo o en el asunto de los mensajes entrantes para que se aplique la condición o excepción.  <br/> |
