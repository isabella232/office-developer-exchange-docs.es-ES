...
El elemento **RetentionPeriod** especifica el número de días durante los que la directiva de retención es en efecto. 
...
El valor de texto del elemento **RetentionPeriod** es el número de días durante los que la directiva de retención es en efecto para un elemento. 
