...
El elemento **RetentionPeriod** especifica el número de días que se aplica la Directiva de retención. 
...
El valor de texto del elemento **RetentionPeriod** es el número de días que la Directiva de retención está vigente para un elemento. 
