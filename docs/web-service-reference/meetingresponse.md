...
El elemento **MeetingResponse** representa una respuesta a la reunión en el almacén de Exchange. 
...
|[ResponseType](responsetype.md) <br/> |Representa el tipo de respuesta de destinatarios que se recibe de una reunión.  <br/> |
