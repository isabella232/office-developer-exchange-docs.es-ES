...
El elemento **EmailAddresses** representa una colección de direcciones de correo electrónico de un contacto. 
...
|**Element**|**Descripción**|
|:-----|:-----|
|[Entrada (EmailAddress)](entry-emailaddress.md) <br/> |Representa una dirección de correo electrónico única para un contacto.  <br/> |
