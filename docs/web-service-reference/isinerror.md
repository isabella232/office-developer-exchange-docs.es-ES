...
El elemento **IsInError** indica si la regla se encuentra en una condición de error. 
...
Un valor de texto de **true** indica que la regla está en una condición de error. Un valor de **false** indica que la regla no se encuentra en una condición de error. 
