...
El elemento **SetTelephoneAccessFolderEmailResponse** define una respuesta a una solicitud de [operación SetTelephoneAccessFolderEmail (servicio web de mensajería unificada)](settelephoneaccessfolderemail-operation-um-web-service.md) . 
