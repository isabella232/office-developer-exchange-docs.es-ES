...
El elemento **ApiVersionSupported** contiene la versión de la API de JavaScript para Office admitida por el cliente. 
...
El valor de texto del elemento **ApiVersionSupported** contiene la versión de la API de JavaScript para Office admitida por el cliente. Este valor indica qué manifiestos de la aplicación se deben devolver al cliente en la respuesta. 
