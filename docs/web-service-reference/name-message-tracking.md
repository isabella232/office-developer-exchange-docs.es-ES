...
---
# <a name="name-message-tracking"></a>Nombre (el seguimiento de mensajes)

El elemento **Name** representa el nombre de la propiedad para un informe de seguimiento de mensajes. 
