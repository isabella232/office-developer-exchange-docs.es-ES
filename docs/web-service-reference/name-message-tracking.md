...
---
# <a name="name-message-tracking"></a>Nombre (seguimiento de mensajes)

El elemento **Name** representa el nombre de la propiedad de un informe de seguimiento de mensajes. 
