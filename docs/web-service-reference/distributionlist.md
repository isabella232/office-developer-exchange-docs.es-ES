...
|[ItemId](itemid.md) <br/> |Contiene el identificador único y la clave de cambio de un elemento de lista de distribución en el Exchange almacén.  <br/> |
|[ParentFolderId](parentfolderid.md) <br/> |Representa el identificador de la carpeta primaria que contiene el elemento de lista de distribución.  <br/> |
...
|[Sensitivity](sensitivity.md) <br/> |Contiene el estado de la confidencialidad de un elemento de lista de distribución.  <br/> |
|[Cuerpo](body.md) <br/> |Representa el contenido del cuerpo real de un elemento de lista de distribución.  <br/> |
|[Adjuntos](attachments-ex15websvcsotherref.md) <br/> |Contiene los elementos o archivos adjuntos a un elemento de lista de distribución en el Exchange almacén.  <br/> |
|[DateTimeReceived](datetimereceived.md) <br/> |Representa la fecha y hora en que se recibió un elemento de lista de distribución en un buzón.  <br/> |
...
|[Categories](categories-ex15websvcsotherref.md) <br/> |Representa una colección de cadenas que identifican a qué categorías pertenece un elemento de lista de distribución en el buzón.  <br/> |
...
|[FileAs](fileas.md) <br/> |Representa cómo se presenta una lista de distribución en la carpeta Contactos.  <br/> |
|[ContactSource](contactsource.md) <br/> |Describe si el contacto se encuentra en el almacén Exchange o en Servicios de dominio de Active Directory (AD DS).  <br/> |
...
|[AppendToItemField](appendtoitemfield.md) <br/> |Identifica los datos que se anexarán a una sola propiedad de una lista de distribución durante una [operación UpdateItem](updateitem-operation.md).  <br/> |
...
|[Create (ItemSync)](create-itemsync.md) <br/> |Identifica una lista de distribución única para crear en el almacén de cliente local.  <br/> |
|[Update (ItemSync)](update-itemsync.md) <br/> |Identifica una única lista de distribución que se actualizará en el almacén de cliente local.  <br/> |
...
|[SetItemField](setitemfield.md) <br/> |Representa una actualización de una sola propiedad de un elemento de lista de distribución en una [operación UpdateItem](updateitem-operation.md).  <br/> |
