...
|:-----|:-----|
|[RestrictedGroupIdentifier](restrictedgroupidentifier.md) <br/> |Representa el identificador de seguridad (SID) de grupo y los atributos de un grupo restringido.  <br/> |
