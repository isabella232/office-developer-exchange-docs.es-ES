...
El elemento **PlayOnPhoneResponse** define una respuesta a una solicitud de [operación PlayOnPhone (servicio web de mensajería unificada)](playonphone-operation-um-web-service.md) . 
