...
description: El elemento LastModifiedTime indica cuándo se modificó por última vez un elemento. Este elemento es de solo lectura.
ms.openlocfilehash: aa511b29072c8d3aa1401d7b9011854249c85d80
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 09/24/2021
ms.locfileid: "59519404"
---
# <a name="lastmodifiedtime"></a>LastModifiedTime

El **elemento LastModifiedTime** indica cuándo se modificó por última vez un elemento. Este elemento es de solo lectura. 
