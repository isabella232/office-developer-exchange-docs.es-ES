...
El elemento **WebClientUrls** representa una configuración de usuario que contiene una colección de elementos de [WebClientUrl (SOAP)](webclienturl-soap.md) . 
...
|**Element**|**Descripción**|
|:-----|:-----|
|[WebClientUrl (SOAP)](webclienturl-soap.md) <br/> |Representa una dirección URL de cliente de Exchange.  <br/> |
   
### <a name="parent-elements"></a>Elementos principales

|**Element**|**Descripción**|
|:-----|:-----|
|[UserSetting (SOAP)](usersetting-soap.md) <br/> |Representa una respuesta a una solicitud de GetUserSettings.  <br/> |
