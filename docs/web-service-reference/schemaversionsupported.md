...
El valor de texto del elemento **SchemaVersionSupported** contiene la versión del esquema del manifiesto admitido por el cliente. Este valor indica qué aplicación manifiestos se deben devolver al cliente en la respuesta. 
