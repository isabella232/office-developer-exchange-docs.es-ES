...
El elemento **IsDelegated** indica si una reunión la controla una cuenta con acceso de delegado. 
...
Un valor de texto de **true** indica que la reunión se controló mediante una cuenta que tiene acceso de delegado. 
