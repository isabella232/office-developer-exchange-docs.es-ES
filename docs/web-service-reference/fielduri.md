...
El elemento **FieldURI** identifica propiedades con frecuencia que se hace referencia mediante un identificador URI. 
...
|carpeta: Id  <br/> |Identifica la propiedad **ID** .  <br/> |
...
|elemento: Id  <br/> |Identifica la propiedad **ID** .  <br/> |
|elemento: ItemClass  <br/> |Identifica la propiedad **ItemClass** .  <br/> |
|elemento: MimeContent  <br/> |Identifica la propiedad **MimeContent** .  <br/> |
|elemento: los datos adjuntos  <br/> |Identifica la propiedad de **los datos adjuntos** .  <br/> |
|Asunto del elemento:  <br/> |Identifica la propiedad **Subject** .  <br/> |
|elemento: DateTimeReceived  <br/> |Identifica la propiedad **DateTimeReceived** .  <br/> |
|Tamaño del elemento:  <br/> |Identifica la propiedad **Size** .  <br/> |
...
|elemento: InReplyTo  <br/> |Identifica la propiedad **InReplyTo** .  <br/> |
...
|Cuerpo del elemento:  <br/> |Identifica la propiedad **Body** .  <br/> |
|elemento: ResponseObjects  <br/> |Identifica la propiedad **ResponseObjects** .  <br/> |
|elemento: sensibilidad  <br/> |Identifica la propiedad **Sensitivity** .  <br/> |
...
|configuración regional del elemento:  <br/> |Identifica la propiedad de **referencia cultural** .  <br/> |
...
|Indicador de elemento:  <br/> |Identifica la propiedad del **indicador** .  <br/> |
...
|itemPolicyTag  <br/> |La propiedad **PolicyTag** Idnentifies.  <br/> |
...
|elemento: vista previa  <br/> |Identifica la propiedad de **vista previa** .  <br/> |
...
|elemento: IsClutter  <br/> |Destinado sólo para uso interno.  <br/> |
...
|mensaje: estáleído  <br/> |Identifica la propiedad **estáleído** .  <br/> |
...
|Referencias de mensaje:  <br/> |Identifica la propiedad de **referencias** .  <br/> |
|mensaje: ReplyTo  <br/> |Identifica la propiedad de **origen** .  <br/> |
|mensaje: desde  <br/> |Identifica la propiedad **From** .  <br/> |
|Remitente del mensaje:  <br/> |Identifica la propiedad del **remitente** .  <br/> |
...
|calendario: final  <br/> |Identifica la propiedad **End** .  <br/> |
...
|Ubicación de calendario:  <br/> |Identifica la propiedad **Location** .  <br/> |
|calendario: cuando  <br/> |Identifica la propiedad **cuando** .  <br/> |
...
|Organizador de calendario:  <br/> |Identifica la propiedad del **Organizador** .  <br/> |
...
|calendario: recursos  <br/> |Identifica la propiedad de **recursos** .  <br/> |
...
|Duración del calendario:  <br/> |Identifica la propiedad de la **duración** .  <br/> |
|calendario: TimeZone  <br/> |Identifica la propiedad de **zona horaria** .  <br/> |
...
|calendario: periodicidad  <br/> |Identifica la propiedad de **Periodicidad** .  <br/> |
...
|tarea: ActualWork  <br/> |Identifica la propiedad **ActualWork** .  <br/> |
...
|tarea: compañías  <br/> |Identifica la propiedad de **las empresas** .  <br/> |
|tarea: CompleteDate  <br/> |Identifica la propiedad **CompleteDate** .  <br/> |
|tarea: contactos  <br/> |Identifica la propiedad de **los contactos** .  <br/> |
|tarea: DelegationState  <br/> |Identifica la propiedad **DelegationState** .  <br/> |
|Delegado de la tarea:  <br/> |Identifica la propiedad de **usuario delegado** .  <br/> |
...
|haya finalizado la tarea:  <br/> |Identifica la propiedad **haya finalizado** .  <br/> |
|tarea: IsRecurring  <br/> |Identifica la propiedad **IsRecurring** .  <br/> |
|tarea: IsTeamTask  <br/> |Identifica la propiedad **IsTeamTask** .  <br/> |
|tarea: Mileage  <br/> |Identifica la propiedad **Mileage** .  <br/> |
|Propietario de la tarea:  <br/> |Identifica la propiedad **Owner** .  <br/> |
|tarea: PercentComplete  <br/> |Identifica la propiedad **PercentComplete** .  <br/> |
|tarea: periodicidad  <br/> |Identifica la propiedad de **Periodicidad** .  <br/> |
|tarea: StartDate  <br/> |Identifica la propiedad **StartDate** .  <br/> |
|Estado de la tarea:  <br/> |Identifica la propiedad **Status** .  <br/> |
|tarea: StatusDescription  <br/> |Identifica la propiedad **StatusDescription** .  <br/> |
|tarea: TotalWork  <br/> |Identifica la propiedad **TotalWork** .  <br/> |
|Alias de los contactos:  <br/> |Identifica la propiedad de **Alias** . Esta propiedad se introdujo en Exchange Server 2010 Service Pack 2 (SP2).  <br/> |
|contactos: AssistantName  <br/> |Identifica la propiedad **AssistantName** .  <br/> |
|contactos: cumpleaños  <br/> |Identifica la propiedad de **cumpleaños** .  <br/> |
|contactos: BusinessHomePage  <br/> |Identifica la propiedad **BusinessHomePage** .  <br/> |
|contactos: elementos secundarios  <br/> |Identifica la propiedad de **elementos secundarios** .  <br/> |
|contactos: compañías  <br/> |Identifica la propiedad de **las empresas** .  <br/> |
|contactos: NombreCompañía  <br/> |Identifica la propiedad **CompanyName** .  <br/> |
...
|contactos: departamento  <br/> |Identifica la propiedad de **departamento** .  <br/> |
...
|contactos: Archivar como  <br/> |Identifica la propiedad **FileAs** .  <br/> |
|contactos: FileAsMapping  <br/> |Identifica la propiedad **FileAsMapping** .  <br/> |
|contactos: generación  <br/> |Identifica la propiedad de **generación** .  <br/> |
|contactos: GivenName  <br/> |Identifica la propiedad **GivenName** .  <br/> |
|contactos: ImAddresses  <br/> |Identifica la propiedad **ImAddresses** .  <br/> |
|contactos: iniciales  <br/> |Identifica la propiedad **iniciales** .  <br/> |
|contactos: JobTitle  <br/> |Identifica la propiedad **JobTitle** .  <br/> |
|Administrador de contactos:  <br/> |Identifica la propiedad **Manager** .  <br/> |
...
|contactos: Mileage  <br/> |Identifica la propiedad **Mileage** .  <br/> |
...
|contactos: sobrenombre  <br/> |Identifica la propiedad de **alias** .  <br/> |
|contactos: notas  <br/> |Identifica la propiedad **Notes** . Esta propiedad se introdujo con SP2 de Exchange 2010.  <br/> |
|contactos: OfficeLocation  <br/> |Identifica la propiedad **OfficeLocation** .  <br/> |
...
|Fotos de contactos:  <br/> |Identifica la propiedad de la **foto** . Esta propiedad se introdujo en Exchange 2010 SP2.  <br/> |
...
|contactos: profesional  <br/> |Identifica el **Profession (** propiedad).  <br/> |
|contactos: NombreCónyuge  <br/> |Identifica la propiedad **NombreCónyuge** .  <br/> |
|contactos: apellido  <br/> |Identifica la propiedad **apellido** .  <br/> |
...
|Tamaño de la conversación:  <br/> |Identifica la propiedad **Size** .  <br/> |
...
|Importancia de conversación:  <br/> |Identifica la propiedad **Importance** .  <br/> |
|conversación: GlobalImportance  <br/> |Identifica la propiedad **GlobalImportance** .  <br/> |
|conversación: ItemId  <br/> |Identifica la propiedad **ItemID** .  <br/> |
...
|conversación: vista previa  <br/> |Identifica la propiedad de **vista previa** .  <br/> |
...
|conversación: HasClutter  <br/> |Destinado sólo para uso interno.  <br/> |
...
|rol: NombreCompañía  <br/> |Identifica la propiedad **CompanyName** .  <br/> |
|rol: apellido  <br/> |Identifica la propiedad **apellido** .  <br/> |
|rol: DisplayName  <br/> |Identifica la propiedad **DisplayName** .  <br/> |
|rol: EmailAddress  <br/> |Identifica la propiedad **EmailAddress** .  <br/> |
|rol: Archivar como  <br/> |Identifica la propiedad **FileAs** .  <br/> |
...
|rol: título  <br/> |Identifica la propiedad de **título** .  <br/> |
|rol: EmailAddresses  <br/> |Identifica la propiedad **EmailAddresses** .  <br/> |
|rol: PhoneNumber  <br/> |Identifica la propiedad **PhoneNumber** .  <br/> |
|rol: ImAddress  <br/> |Identifica la propiedad **ImAddress** .  <br/> |
|rol: ImAddresses  <br/> |Identifica la propiedad **ImAddresses** .  <br/> |
...
|rol: iniciales  <br/> |Identifica la propiedad **iniciales** .  <br/> |
...
|rol: Apellidos  <br/> |Identifica la propiedad de **Apellidos** .  <br/> |
|rol: generaciones  <br/> |Identifica la propiedad de **generaciones** .  <br/> |
|rol: sobrenombres  <br/> |Identifica la propiedad de **sobrenombres** .  <br/> |
...
|rol: buscapersonas  <br/> |Identifica la propiedad **localizadores** .  <br/> |
|rol: RadioPhones  <br/> |Identifica la propiedad **RadioPhones** .  <br/> |
...
|rol: School  <br/> |Identifica la propiedad de la **escuela** .  <br/> |
...
|Títulos de un rol:  <br/> |Identifica la propiedad de **los títulos** .  <br/> |
|rol: departamentos  <br/> |Identifica la propiedad de **departamentos** .  <br/> |
|rol: CompanyNames  <br/> |Identifica la propiedad **CompanyNames** .  <br/> |
|Jefes de rol:  <br/> |Identifica la propiedad de **los administradores** .  <br/> |
|rol: AssistantNames  <br/> |Identifica la propiedad **AssistantNames** .  <br/> |
|rol: profesionales  <br/> |Identifica la propiedad **profesionales** .  <br/> |
|rol: SpouseNames  <br/> |Identifica la propiedad **SpouseNames** .  <br/> |
|rol: aficiones  <br/> |Identifica la propiedad de **las aficiones** .  <br/> |
|rol: WeddingAnniversaries  <br/> |Identifica la propiedad **WeddingAnniversaries** .  <br/> |
|rol: cumpleaños  <br/> |Identifica la propiedad de **cumpleaños** .  <br/> |
|rol: elementos secundarios  <br/> |Identifica la propiedad de **elementos secundarios** .  <br/> |
|Ubicaciones de rol:  <br/> |Identifica la propiedad de **las ubicaciones** .  <br/> |
...
|rol: cuerpos  <br/> |Identifica la propiedad de **cuerpos** .  <br/> |
...
|**Element**|**Descripción**|
|:-----|:-----|
|[AdditionalProperties](additionalproperties.md) <br/> | Identifica las propiedades adicionales para obtener, establecer o crear.  <br/>  Los siguientes son las expresiones de XPath para este elemento:  <br/>  `/FindFolder/FolderShape/AdditionalProperties` <br/>  `/GetFolder/FolderShape/AdditionalProperties` <br/>  `/SyncFolderHierarchy/FolderShape/AdditionalProperties` <br/>  `/GetItem/ItemShape/AdditionalProperties` <br/>  `/FindItem/ItemShape/AdditionalProperties` <br/>  `/SyncFolderItems/ItemShape/AdditionalProperties` <br/>  `/GetAttachment/AttachmentShape/AdditionalProperties` <br/> |
...
|[SetFolderField](setfolderfield.md) <br/> |Representa una actualización a una propiedad única en una carpeta en una operación UpdateFolder.  <br/> |
|[DeleteItemField](deleteitemfield.md) <br/> |Representa una operación de eliminación para eliminar una propiedad determinada de un elemento durante una llamada UpdateItem.  <br/> |
