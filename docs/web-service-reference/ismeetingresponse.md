...
El elemento **IsMeetngResponsequest** indica si los mensajes entrantes deben ser una respuesta a la reunión en orden para la condición o la excepción que se debe aplicar. 
...
Un valor de texto de **true** indica que el mensaje debe ser una respuesta a la reunión en orden para la condición o la excepción que se debe aplicar. Un valor de texto de **false** indica que el mensaje no debe ser una respuesta a la reunión en orden para la condición o la excepción que se debe aplicar. 
