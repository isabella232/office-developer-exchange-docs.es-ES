...
description: El elemento IsMeetngResponsequest indica si los mensajes entrantes deben ser una respuesta de reunión para que se aplique la condición o excepción.
ms.openlocfilehash: ff6008eef7ae5198738e68db62303b06a619e41d
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 09/24/2021
ms.locfileid: "59532754"
---
# <a name="ismeetingresponse"></a>IsMeetingResponse

El **elemento IsMeetngResponsequest** indica si los mensajes entrantes deben ser una respuesta de reunión para que se aplique la condición o excepción. 
