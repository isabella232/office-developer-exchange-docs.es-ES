...
El elemento **WebClientReadFormQueryString** representa una dirección URL a concatene al extremo de Outlook Web App para leer un elemento en Outlook Web App. 
...
Las versiones de Exchange con la versión principal 15 iniciales y finales con Exchange Server 2013 generación 15.0.775.38 (CU3) y Exchange Online versión 15.00.0775.009 no devuelven un fragmento de la cadena de consulta correcta en el elemento **WebClientReadFormQueryString** . 
  
En las versiones de Exchange anteriores a la versión principal 15, el identificador de elemento para las direcciones URL de Outlook Web App es un identificador de Outlook Web App. Si el destino es una versión de Exchange anterior a la versión principal 15, se debe usar la [operación de ConvertId](convertid-operation.md) para convertir el identificador. 
