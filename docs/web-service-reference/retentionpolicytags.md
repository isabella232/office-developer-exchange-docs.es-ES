...
El elemento **RetentionPolicyTags** contiene una lista de etiquetas de retención devueltas en la respuesta de la operación WSDL de **GetUserRetentionPolicyTags** . 
