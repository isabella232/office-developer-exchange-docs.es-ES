...
El elemento **RetentionPolicyTags** contiene una lista de etiquetas de retención devuelto en la respuesta de la operación de WSDL **GetUserRetentionPolicyTags** . 
