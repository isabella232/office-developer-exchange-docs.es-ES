...
La operación **GetServiceConfiguration** obtiene información de configuración para el tipo de servicio especificado. Esta operación puede devolver valores de configuración de los servicios de mensajería unificada, las reglas de protección y las sugerencias de correo. 
  
## <a name="getserviceconfiguration-request-example"></a>Ejemplo de solicitud de GetServiceConfiguration

### <a name="description"></a>Descripción

El siguiente ejemplo de una solicitud de **GetServiceConfiguration** muestra cómo formar una solicitud para obtener información de configuración para el servicio de mensajería unificada. 
...
En el ejemplo siguiente se muestra una respuesta correcta a la solicitud de **GetServiceConfiguration** . 
...
## <a name="getserviceconfiguration-error-response-example"></a>Ejemplo de respuesta de GetServiceConfiguration Error

### <a name="description"></a>Descripción

En el ejemplo siguiente se muestra una respuesta de error a la solicitud de **GetServiceConfiguration** . Este error se produjo por un nombre de configuración incorrecta. 
