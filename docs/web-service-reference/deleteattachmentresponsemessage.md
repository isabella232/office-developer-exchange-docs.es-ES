...
|:-----|:-----|
|**ResponseClass** <br/> | Describe el estado de una respuesta de operación [DeleteAttachment.](deleteattachment-operation.md)<br/><br/>Los siguientes valores son válidos para este atributo:<br/><br/>- Éxito  <br/>- Advertencia  <br/>- Error  <br/> |
