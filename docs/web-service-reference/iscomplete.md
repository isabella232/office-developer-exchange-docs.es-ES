...
---
# <a name="iscomplete"></a>Haya finalizado

El elemento **haya finalizado la** indica si se ha completado la tarea. 
...
El valor de texto es un valor booleano que indica si la tarea se ha completado.
