...
El elemento **GetUserSettingsRequestMessage** representa una solicitud de [operación GetUserSettings (SOAP)](getusersettings-operation-soap.md) . 
...
|**Element**|**Descripción**|
|:-----|:-----|
|[Solicitud (SOAP)](request-soap.md) <br/> |Contiene las opciones de configuración solicitado.  <br/> |
