...
El elemento **ReminderTime** especifica el tiempo para que se produzca el aviso. 
...
El valor de texto del elemento **ReminderTime** es el tiempo para que se produzca el aviso. 
