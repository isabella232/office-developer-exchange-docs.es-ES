...
El elemento de **país** representa el país o la región para una determinada dirección física. 
...
El valor de texto es un valor de tipo string que representa el nombre de un país.
