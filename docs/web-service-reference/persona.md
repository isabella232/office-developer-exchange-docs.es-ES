...
description: El elemento de rol especifica un conjunto de datos de rol devueltos por una solicitud GetPersona.
ms.openlocfilehash: 093b346300b5fdcbfb31f2e1240d57d9476e250a
ms.sourcegitcommit: 88ec988f2bb67c1866d06b361615f3674a24e795
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 06/03/2020
ms.locfileid: "44465880"
---
# <a name="persona"></a><span data-ttu-id="c3b71-103">Rol</span><span class="sxs-lookup"><span data-stu-id="c3b71-103">Persona</span></span>

<span data-ttu-id="c3b71-104">El elemento de **rol** especifica un conjunto de datos de rol devueltos por una solicitud **GetPersona** .</span><span class="sxs-lookup"><span data-stu-id="c3b71-104">The **Persona** element specifies a set of persona data returned by a **GetPersona** request.</span></span> 
