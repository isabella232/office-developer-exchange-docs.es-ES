...
---
# <a name="persona"></a><span data-ttu-id="198af-103">Rol</span><span class="sxs-lookup"><span data-stu-id="198af-103">Persona</span></span>

<span data-ttu-id="198af-104">El elemento de **rol** especifica un conjunto de datos de rol devueltos por una solicitud de **GetPersona** .</span><span class="sxs-lookup"><span data-stu-id="198af-104">The **Persona** element specifies a set of persona data returned by a **GetPersona** request.</span></span> 
