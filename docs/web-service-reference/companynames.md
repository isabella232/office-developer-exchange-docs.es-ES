...
---
# <a name="companynames"></a>NombreCompañía

El elemento **CompanyNames** contiene una matriz de nombres de compañía y los identificadores de sus atribuciones de origen para el rol asociado. 
