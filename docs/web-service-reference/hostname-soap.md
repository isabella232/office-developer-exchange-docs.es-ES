...
El elemento de **nombre de host** representa la parte del nombre completo del equipo del equipo en el nombre de host. 
...
El valor de texto del elemento de **nombre de host** es la parte del nombre completo del equipo del equipo en el nombre de host. 
