...
El elemento **LastResponseTime** representa la fecha y hora de la última respuesta recibida. 
...
Se requiere un valor de texto que representa la fecha y hora de la respuesta más reciente.
