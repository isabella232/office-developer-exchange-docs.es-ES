...
El elemento **RoomLists** es una lista de una o varias direcciones que representan una lista de salas de reuniones. 
...
|:-----|:-----|
|[Dirección (EmailAddressType)](address-emailaddresstype.md) <br/> |Define la dirección de correo electrónico y el nombre para mostrar que representan la lista de salas. Este elemento es opcional.  <br/> |
