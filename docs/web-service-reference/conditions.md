...
|[IsPermissionControlled](ispermissioncontrolled.md) <br/> |Indica si los mensajes entrantes deben ser controlados por permisos (protegidos por RMS) para que se aplique la condición o excepción.  <br/> |
