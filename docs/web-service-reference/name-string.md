...
---
# <a name="name-string"></a>Name (cadena)

El elemento **Name** especifica un nombre de refinador de búsqueda. 
...
El valor de texto del elemento **Name** es el nombre del refinador de búsqueda. 
