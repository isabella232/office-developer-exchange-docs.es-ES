...
description: El elemento IsDeliveryReceiptRequested indica si el remitente de un elemento solicita un recibo de entrega.
ms.openlocfilehash: 10f07e5732c8bc87930337027fa59160617f438b
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 09/24/2021
ms.locfileid: "59515568"
---
# <a name="isdeliveryreceiptrequested"></a>IsDeliveryReceiptRequested

El **elemento IsDeliveryReceiptRequested** indica si el remitente de un elemento solicita un recibo de entrega. 
...
Un valor de texto **de true** indica que se solicita un recibo de entrega al destinatario del elemento. 
