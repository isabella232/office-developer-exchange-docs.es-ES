...
El elemento **MonthlyRegeneration** describe la frecuencia, en meses, de los cuales se regenera la tarea. 
...
|**Element**|**Descripción**|
|:-----|:-----|
|[Interval](interval.md) <br/> |Define el intervalo de meses entre dos elementos periódicos consecutivos.  <br/> |
