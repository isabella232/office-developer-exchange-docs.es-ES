...
description: El elemento DisplayTo representa la cadena para mostrar que se usa para el contenido del cuadro Para. Esta es la cadena concatenada de todos los nombres para mostrar de destinatarios To.
...
El **elemento DisplayTo** representa la cadena para mostrar que se usa para el contenido del cuadro Para. Esta es la cadena concatenada de todos los nombres para mostrar de destinatarios To. 
...
El valor de texto representa la cadena para mostrar que se usa para el contenido del cuadro Para.
