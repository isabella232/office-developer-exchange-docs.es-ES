...
El elemento de **valores** contiene una colección de valores para una propiedad extendida. 
...
|**Element**|**Descripción**|
|:-----|:-----|
|[Value](value.md) <br/> |Contiene un valor de una propiedad extendida.  <br/> |
