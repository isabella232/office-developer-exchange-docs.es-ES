...
El elemento **CalendarFolderPermissionLevel** contiene los permisos para la carpeta de calendario predeterminada. Este elemento se introdujo en Microsoft Exchange Server 2007 Service Pack 1 (SP1). 
...
|Reviewer  <br/> |El usuario delegado puede leer los elementos de la carpeta calendario.  <br/> |
|Autor  <br/> |El usuario delegado puede leer y crear elementos en la carpeta calendario.  <br/> |
|Editor  <br/> |El usuario delegado puede leer, crear y modificar los elementos de la carpeta calendario.  <br/> |
