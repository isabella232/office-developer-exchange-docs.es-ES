...
El elemento **IsAutomaticForward** indica si los mensajes entrantes deben ser reenvíos automáticos en orden para la condición o la excepción que se debe aplicar. 
...
Un valor de texto de **true** indica que el mensaje debe ser un reenvío automático en orden para la condición o la excepción que se debe aplicar. Un valor de **false** indica que el mensaje no debe ser un reenvío automático en orden para la condición o la excepción que se debe aplicar. 
