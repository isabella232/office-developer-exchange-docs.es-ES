...
El elemento **CompanyNameSortKey** contiene la clave de ordenación para un nombre de compañía. 
...
El valor de texto del elemento **CompanyNameSortKey** es la clave de ordenación para el nombre de una compañía. 
