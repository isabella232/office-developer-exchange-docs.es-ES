...
El elemento **DeletedOccurrences** contiene una matriz de eliminado apariciones de un elemento periódico del calendario. 
...
Este elemento es válida si el valor de texto RecurringMaster se usa para el elemento [CalendarItemType](calendaritemtype.md) . 
