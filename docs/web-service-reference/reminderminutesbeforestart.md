...
El elemento **ReminderMinutesBeforeStart** representa el número de minutos antes de que un evento se produce cuando se muestra un aviso. 
...
Representa el valor de texto, en minutos, el tiempo antes de que un evento se produce cuando se muestra un aviso.
