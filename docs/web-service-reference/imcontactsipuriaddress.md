...
El elemento **ImContactSipUriAddress** contiene la dirección URI de SIP de un contacto que se agrega a un grupo (IM) de mensajería instantánea. 
...
El valor de texto del elemento **ImContactSipUriAddress** es la dirección URI de SIP de un contacto. 
