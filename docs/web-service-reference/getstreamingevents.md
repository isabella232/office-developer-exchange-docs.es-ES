...
El elemento **GetStreamingEvents** representa la operación que se usa en los clientes para solicitar las notificaciones de transmisión por secuencias desde el servidor. 
...
|**Element**|**Descripción**|
|:-----|:-----|
|[SubscriptionId (GetStreamingEvents)](subscriptionid-getstreamingevents.md) <br/> |Representa el identificador para una suscripción que se consulta para los eventos.  <br/> |
|[ConnectionTimeout](connectiontimeout.md) <br/> |Representa el número de minutos que desea mantener una conexión abierta.  <br/> |
