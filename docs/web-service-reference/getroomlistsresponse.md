...
|[RoomLists](roomlists.md) <br/> |Proporciona una lista de direcciones de correo electrónico y nombres para mostrar que representan listas de salas de reuniones.  <br/> |
