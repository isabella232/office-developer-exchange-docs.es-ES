...
El elemento **SenderSmtpAddress** representa la dirección de correo electrónico SMTP correspondiente para el buzón de correo que contiene la carpeta que se van a compartir. 
