...
|**Element**|**Descripción**|
|:-----|:-----|
|[Identificador (cadena)](id-string.md) <br/> |Especifica el identificador de un elemento.  <br/> |
|[DisableReason](disablereason.md) <br/> |Especifica la razón para deshabilitar una aplicación.  <br/> |
