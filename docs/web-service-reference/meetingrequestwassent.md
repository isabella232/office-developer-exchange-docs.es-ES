...
Si se incluye este elemento, es necesario un valor de texto que represente un valor booleano. Un valor de **true** indica que se envió una convocatoria de reunión. Un valor de **false** indica que no se ha enviado una convocatoria de reunión. 
