...
El elemento **GivenName** contiene el nombre especificado de un contacto. 
...
Si se usa este elemento, es necesario un valor de texto que represente el nombre especificado de un contacto.
  
## <a name="remarks"></a>Comentarios

Un nombre determinado suele ser el nombre de una persona.
