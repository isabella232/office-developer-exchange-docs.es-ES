...
El elemento **GivenName** contiene el nombre de un contacto determinado. 
...
Si se usa este elemento, es necesario un valor de texto que representa el nombre de un contacto determinado.
  
## <a name="remarks"></a>Notas

Un nombre dado suele ser un nombre de la persona.
