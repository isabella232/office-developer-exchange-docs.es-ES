...
El elemento **ExecutedSearchScope** contiene el ámbito de la búsqueda que se ha realizado para obtener los resultados de la búsqueda. 
...
El valor de texto es opcional. Esta información se usa en la aplicación cliente para almacenar los resultados de forma más eficaz.
