...
Un valor de texto **de true** indica que el elemento está asociado a una carpeta; un valor de **false** indica que el elemento no está asociado a una carpeta. 
