...
El elemento **UploadItems** representa una solicitud para cargar los elementos en un buzón de correo. 
...
|**Element**|**Descripción**|
|:-----|:-----|
|[Elementos (NonEmptyArrayOfUploadItemsType)](items-nonemptyarrayofuploaditemstype.md) <br/> |Contiene una matriz de elementos que desea cargar en un buzón de correo.  <br/> |
