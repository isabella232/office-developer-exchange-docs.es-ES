...
El elemento **GlobalMessageCount** contiene el número total de elementos de la conversación en el buzón de correo. 
...
El valor de texto del elemento **GlobalMessageCount** es el número total de elementos de la conversación en un buzón de correo. 
