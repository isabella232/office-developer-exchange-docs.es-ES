...
El elemento **OpenAsAdminOrSystemService** es solo para uso interno. Los clientes no usan este elemento. 
...
|:-----|:-----|
|LogonType  <br/> |No está destinado al uso de clientes.  <br/> |
   
### <a name="child-elements"></a>Elementos secundarios

|**Elemento**|**Descripción**|
|:-----|:-----|
|ConnectingSID  <br/> |No está destinado al uso de clientes.  <br/> |
