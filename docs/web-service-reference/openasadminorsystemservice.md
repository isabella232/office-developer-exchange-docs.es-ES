...
El elemento **OpenAsAdminOrSystemService** es sólo para uso interno. Este elemento no se usa en los clientes. 
...
|:-----|:-----|
|LogonType  <br/> |No está pensado para uso del cliente.  <br/> |
   
### <a name="child-elements"></a>Elementos secundarios

|**Element**|**Descripción**|
|:-----|:-----|
|ConnectingSID  <br/> |No está pensado para uso del cliente.  <br/> |
