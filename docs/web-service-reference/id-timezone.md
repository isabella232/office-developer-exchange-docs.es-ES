...
El elemento **ID** identifica una única definición de zona horaria. 
...
|:-----|:-----|
|[Falta](ids.md) <br/> |Contiene una matriz de identificadores de definición de zona horaria.  <br/> |
   
## <a name="text-value"></a>Valor de texto

Se requiere un valor de texto. El valor de texto representa el identificador único para la definición de la zona horaria.
