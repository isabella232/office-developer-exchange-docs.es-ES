...
---
# <a name="id-timezone"></a>Identificador (TimeZone)

El elemento **Id** identifica una definición de zona horaria único. 
...
|**Element**|**Descripción**|
|:-----|:-----|
|[Identificadores de](ids.md) <br/> |Contiene una matriz de identificadores de definición de zona horaria.  <br/> |
   
## <a name="text-value"></a>Valor de texto

Se requiere un valor de texto. El valor de texto representa el identificador único para la definición de zona horaria.
