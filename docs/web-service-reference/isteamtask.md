...
El elemento **IsTeamTask** indica si la tarea es propiedad de un equipo. 
...
El valor de texto representa un valor booleano que indica si una tarea es propiedad de un equipo. Se trata de una propiedad de solo lectura.
