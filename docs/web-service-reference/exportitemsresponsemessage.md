...
El elemento **ExportItemsResponseMessage** contiene el estado y los resultados de una solicitud para exportar un elemento de un solo buzón de correo. 
...
|[ItemId](itemid.md) <br/> |Contiene el identificador del elemento de un elemento exportado.  <br/> |
|[Datos (base64Binary)](data-base64binary.md) <br/> |Contiene el contenido de un elemento exportado.  <br/> |
