...
El elemento **InternalId** representa un valor entero para la identificación de los eventos. 
...
Si se usa este elemento, es necesario un valor de texto que representa un número entero.
