...
El elemento **InternalId** representa un valor entero para la identificación del evento. 
...
Es necesario un valor de texto que representa un entero si se usa este elemento.
