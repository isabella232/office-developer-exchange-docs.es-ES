...
El elemento **DisplayNameFirstLastSortKey** contiene la clave de ordenación para un nombre para mostrar en el cuadro Nombre, apellidos. 
...
El valor de texto del elemento **DisplayNameFirstLastSortKey** es la clave de ordenación para el nombre para mostrar de un rol, en el cuadro Nombre, apellidos. 
