...
---
# <a name="values-arrayofstringvaluetype"></a>Valores (ArrayOfStringValueType)

El elemento de **valores** especifica los valores de una matriz de las propiedades de rol asociadas con una matriz de atribuciones. 
