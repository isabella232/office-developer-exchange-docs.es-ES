...
El elemento **WorkCitySortKey** contiene el criterio de ordenación para los valores de ciudad de trabajo asociados a un rol. 
...
El valor de texto del elemento **WorkCitySortKey** contiene un criterio de ordenación para ordenar las propiedades de la ciudad de trabajo de los contactos que componen un rol. 
