...
El valor del **elemento GlobalHasAttachments** indica si al menos un elemento de conversación de un buzón tiene datos adjuntos. Se requiere un valor de texto que representa un valor booleano. Un valor de **true significa** que la conversación tiene al menos un dato adjunto visible. Un valor de **false** significa que la conversación no tiene datos adjuntos o solo tiene datos adjuntos ocultos. 
