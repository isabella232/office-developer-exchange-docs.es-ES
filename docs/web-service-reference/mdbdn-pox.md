...
El elemento **MdbDN** representa el nombre distintivo de la base de datos de buzones de correo. 
...
El valor de texto representa el nombre distintivo de la base de datos de buzones.
