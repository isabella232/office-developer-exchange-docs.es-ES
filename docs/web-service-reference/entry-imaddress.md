...
El elemento **entry** representa una dirección de mensajería instantánea (mi) de un contacto. 
...
|:-----|:-----|
|**Key** <br/> | Identifica la dirección de mi.<br/><br/>A continuación se muestran los valores posibles para este atributo:<br/><br/>- ImAddress1  <br/>- ImAddress2  <br/>- ImAddress3  <br/> |
