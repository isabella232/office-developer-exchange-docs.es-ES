...
---
# <a name="cchksgfilesnoflags-enumeration"></a>CChkSGFiles.NO_FLAGS (enumeración)

**Se aplica a:** Exchange Server 2003 | Exchange Server 2007 | Exchange Server 2010 | Exchange Server 2013
  
Actúa como un valor de marcador de posición para los parámetros **ulFlags** que se aceptan por la mayoría de las funciones de clase de **CCheckSGFiles** . 
