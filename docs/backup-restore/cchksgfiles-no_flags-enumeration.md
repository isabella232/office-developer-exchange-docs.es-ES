...
---
# <a name="cchksgfilesno_flags-enumeration"></a>Enumeración función cchksgfiles. NO_FLAGS

**Se aplica a:** Exchange Server 2003 | Exchange Server 2007 | Exchange Server 2010 | Exchange Server 2013
  
Sirve como un valor de marcador de posición para los parámetros **ulFlags** que son aceptados por la mayoría de las funciones de clase **CCheckSGFiles** . 
