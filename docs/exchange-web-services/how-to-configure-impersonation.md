...
-  _Name_: el nombre descriptivo de la asignación de roles. Cada vez que asigna un rol, se realiza una entrada en la lista de roles RBAC. Puede comprobar las asignaciones de funciones con el cmdlet [Get-ManagementRoleAssignment](http://msdn.microsoft.com/library/a3a6ee46-061b-444a-8639-43a416309445.aspx). 
...
- [Rol ApplicationImpersonation](http://technet.microsoft.com/es-ES/library/dd776119%28v=exchg.150%29.aspx)   
