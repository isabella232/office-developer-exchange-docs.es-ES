...
> [!NOTE]
> Estas son sugerencias de seguridad básicas. Siempre que se trabaje con la autenticación, asegúrese de que el código cumple con los requisitos de seguridad de la organización. 
...
- [Mejorar el rendimiento al usar la Detección automática de Exchange](improving-performance-when-using-autodiscover-for-exchange.md)
