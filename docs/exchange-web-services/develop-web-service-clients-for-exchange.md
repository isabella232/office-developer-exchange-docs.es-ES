...
Obtenga información que le ayude a desarrollar aplicaciones de cliente de servicio Web y EWS para Exchange.
...
- [Identificadores en Exchange](ews-identifiers-in-exchange.md)
...
- [Comprobación de los resultados de una llamada de API administrada de EWS o EWS](verifying-the-results-of-an-ews-or-ews-managed-api-call.md)
